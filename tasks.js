...
//   res = [];
//   newNum1 = num1.split('').reverse();
//   newNum2 = num2.split('').reverse();
//   newNum1 =  newNum1.map( item => +item);
//   newNum2 =  newNum2.map( item => +item);
...
//     sum = 0;
//     sum = newNum1[i] + newNum2[i];

//     if (sum >= 10) {
//       if (newNum1[i+1] == undefined) {
//         newNum1[i+1] = 0;
//         newNum2[i+1] = 0;
//       }
//       newNum1[i+1] = newNum1[i+1] + Math.floor(sum / 10);
//       sum = sum % 10;
//     }
...
// };
// console.log(countBits(101));

// function solve(n) {
//   if ( n % 10 !== 0 ) { console.log(-1)}
//   count = Math.floor(n / 500);  
//   n = n - Math.floor(n / 500) * 500;
     
//   count += Math.floor(n / 200);
...
//  console.log(solve(3450))

//  function solve(n) { 
//   return n%10 !== 0 ? -1 :[500,200,100,50,20,10].reduce((notes, value) => {
//     if( n/value >= 1) {
//       notes += Math.floor(n/value);
//       n %= value;
//     }
//     return notes;
//   }, 0);          
...
// var showData = user.showData.bind(userWithoutShow );
// showData();
// console.log(Object.keys(userWithoutShow))
function greet (gender, name, age) {
...
var greetAYoungster = greet.bind (null, "", 'Alex');




const calc = (one, two,three) => {
  let result = (one + two)**three;
  return (`result ${result}`);
}
const addThree = calc.bind(null,1,1);
